...
document.getElementById("q1").innerHTML = (num1 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num2 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q2").innerHTML = (num3 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num4 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q3").innerHTML = (num5 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num6 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q4").innerHTML = (num7 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num8 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q5").innerHTML = (num9 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num10 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q6").innerHTML = (num11 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num12 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q7").innerHTML = (num13 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num14 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q8").innerHTML = (num15 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num16 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q9").innerHTML = (num17 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num18 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q10").innerHTML = (num19 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num20 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q11").innerHTML = (num21 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num22 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q12").innerHTML = (num23 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num24 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q13").innerHTML = (num25 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num26 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q14").innerHTML = (num27 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num28 = Math.floor(Math.random()*(999-100+1))+100)+"=";
document.getElementById("q15").innerHTML = (num29 = Math.floor(Math.random()*(999-100+1))+100)+ "+" +(num30 = Math.floor(Math.random()*(999-100+1))+100)+"=";
