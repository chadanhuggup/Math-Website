...
document.getElementById("q1").innerHTML = (num1 = Math.floor(Math.random()*10))+ "x" +(num2 = Math.floor(Math.random()*10))+"=";
document.getElementById("q2").innerHTML = (num3 = Math.floor(Math.random()*10))+ "x" +(num4 = Math.floor(Math.random()*10))+"=";
document.getElementById("q3").innerHTML = (num5 = Math.floor(Math.random()*10))+ "x" +(num6 = Math.floor(Math.random()*10))+"=";
document.getElementById("q4").innerHTML = (num7 = Math.floor(Math.random()*10))+ "x" +(num8 = Math.floor(Math.random()*10))+"=";
document.getElementById("q5").innerHTML = (num9 = Math.floor(Math.random()*10))+ "x" +(num10 = Math.floor(Math.random()*10))+"=";
document.getElementById("q6").innerHTML = (num11 = Math.floor(Math.random()*10))+ "x" +(num12 = Math.floor(Math.random()*10))+"=";
document.getElementById("q7").innerHTML = (num13 = Math.floor(Math.random()*10))+ "x" +(num14 = Math.floor(Math.random()*10))+"=";
document.getElementById("q8").innerHTML = (num15 = Math.floor(Math.random()*10))+ "x" +(num16 = Math.floor(Math.random()*10))+"=";
document.getElementById("q9").innerHTML = (num17 = Math.floor(Math.random()*10))+ "x" +(num18 = Math.floor(Math.random()*10))+"=";
document.getElementById("q10").innerHTML = (num19 = Math.floor(Math.random()*10))+ "x" +(num20 = Math.floor(Math.random()*10))+"=";
document.getElementById("q11").innerHTML = (num21 = Math.floor(Math.random()*10))+ "x" +(num22 = Math.floor(Math.random()*10))+"=";
document.getElementById("q12").innerHTML = (num23 = Math.floor(Math.random()*10))+ "x" +(num24 = Math.floor(Math.random()*10))+"=";
document.getElementById("q13").innerHTML = (num25 = Math.floor(Math.random()*10))+ "x" +(num26 = Math.floor(Math.random()*10))+"=";
document.getElementById("q14").innerHTML = (num27 = Math.floor(Math.random()*10))+ "x" +(num28 = Math.floor(Math.random()*10))+"=";
document.getElementById("q15").innerHTML = (num29 = Math.floor(Math.random()*10))+ "x" +(num30 = Math.floor(Math.random()*10))+"=";
